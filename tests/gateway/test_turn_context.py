...
class TestTurnRunner:
    ...
    def test_run_sync_threads_display_metadata_to_agent(self):
        seen = {}
        ...
        assert seen["persist_user_display_kind"] == "internal_notification"
        assert seen["persist_user_display_metadata"] == metadata
