...
the user's focus). To show or close a URL/file, use ``desktop_preview``.
"""
...
FOCUS_PANE_SCHEMA = {
    ...
    "description": (
        ...
        "To show or close a URL or file in the preview pane, use desktop_preview "
        "with action='open' or action='close'."
    ),
    "parameters": {
        "type": "object",
        "properties": {
