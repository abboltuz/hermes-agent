...
def finalize_turn(
    ...
    *,
    ...
    kanban_terminal_transition = get_kanban_terminal_transition(agent)
    ...
    budget_fallback_eligible = (
        budget_exhausted
        and kanban_terminal_transition is None
        and not interrupted
        and not failed
    ...
    elif budget_exhausted and kanban_terminal_transition is None:
    ...
    completed = (
        ...
        and not failed
        and (
            kanban_terminal_transition is not None
    ...
    if kanban_terminal_transition is None:
        try:
    ...
    try:
        ...
        if not interrupted and not failed:
            try:
                ...
                if (
                    kanban_terminal_transition is None
                    and _compressor
    ...
    if kanban_terminal_transition is None and not interrupted:
        try:
