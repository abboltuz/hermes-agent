...
compression:
  ...
  tail_mode: lean                                   # Tail retention: "lean" (default; clamped 2.5% tail, 10K-25K, with one-call detailed log + anchor index + recovery pointers) or explicit compatibility mode "legacy"
